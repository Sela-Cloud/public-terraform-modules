...
module "cloud_sql_instance" {
  source   = "git::https://github.com/Sela-Cloud/public-terraform-modules//modules/cloud-sql-instance?ref=v0.6.7"
...
module "cloud_sql_database" {
  source   = "git::https://github.com/Sela-Cloud/public-terraform-modules//modules/cloud-sql-database?ref=v0.6.7"
...
module "cloud_sql_user" {
  source   = "git::https://github.com/Sela-Cloud/public-terraform-modules//modules/cloud-sql-user?ref=v0.6.7"
