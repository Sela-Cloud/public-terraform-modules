...
module "custom_roles" {
  ...
  source      = "git::https://github.com/Sela-Cloud/public-terraform-modules//modules/iam/custom-role?ref=v0.6.9"
...
module "service_accounts" {
  ...
  source                         = "git::https://github.com/Sela-Cloud/public-terraform-modules//modules/iam/service-account?ref=v0.6.9"
...
module "member_roles" {
  ...
  source  = "git::https://github.com/Sela-Cloud/public-terraform-modules//modules/iam/member-iam?ref=v0.6.9"
  project = var.project_id
