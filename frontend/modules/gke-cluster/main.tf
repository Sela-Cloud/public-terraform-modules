...
module "gke_autopilot" {
  source = "git::https://github.com/Sela-Cloud/public-terraform-modules//modules/gke-autopilot?ref=v0.6.20"
...
module "gke_standard_cluster" {
  source = "git::https://github.com/Sela-Cloud/public-terraform-modules//modules/gke-standard-cluster?ref=v0.6.20"
...
module "gke_standard_node_pool" {
  source   = "git::https://github.com/Sela-Cloud/public-terraform-modules//modules/gke-standard-node-pool?ref=v0.6.20"
