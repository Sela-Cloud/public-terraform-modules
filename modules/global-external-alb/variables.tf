...
variable "backend_services" {
  description = "HTTP(S) backends, keyed by service_name. target_type selects umig, mig, neg, or cloud_run fields."
  type = map(object({
    service_name = string
    ...
    # An existing network endpoint group, created and owned elsewhere.
